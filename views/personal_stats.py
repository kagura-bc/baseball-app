        ...
        with st_game:
            if not df_batting.empty or not df_pitching.empty:
                ...
                if not df_all_logs.empty:
                    ...
                    # ==========================================
                    # 【修正】以前はここで「チーム記録」を除外していましたが、
                    # チームの総試合数を正確にカウントするために下へ移動しました。
                    # ==========================================
                    ...
                    # 2. 個人参加数の計算
                    # ==========================================
                    # ★ここで初めて「チーム記録」を個人のランキング計算から除外する
