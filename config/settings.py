...
# グラウンドリスト
GROUND_LIST = [
    "小瀬スポーツ公園", "緑が丘スポーツ公園", "飯田球場", "ふじでん球場", "青葉球場",
...
# 対戦相手リスト
OPPONENTS_LIST = [
    "ミッピーズ", "WISH", "NATSUME", "92ears", "球遊会", "プリティーボーイズ", "サブ", "ハイウェイスター",
    "DREAM", "リベリオン", "KING STAR", "甲府市役所", "SQUAD", "CRAZY", "レッドレヴォリューション", "日東建設", "スリーナイン",
    "桜華", "甲府ドラゴンズ", "南アルプス市役所", "風間自工", "凪", "フェノーメノ", "石和体協", "JAPBOYS", "PIONES", "DarkLegion", "イヌティーレ", "その他"
]
